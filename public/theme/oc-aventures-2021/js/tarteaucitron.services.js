...
tarteaucitron.services.youtube = {
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['youtube_player'], function (x) {
            var video_url = x.getAttribute("video-url"),
                video_width = x.getAttribute("video-width"),
                frame_width = 'width=',
                video_height = x.getAttribute("video-height"),
                frame_height = 'height=',
                video_frame,
            ...
            video_frame = '<figure class="image is-16by9"><iframe class="has-ratio" type="text/html" ' + frame_width + frame_height + 'src="' + video_url + '?' + params + '" frameborder="0" allowfullscreen></iframe></figure>';
            return video_frame;
        });
    },
    "fallback": function () {
